<script>
  ...
  <Section name="blog">
    <BlogHead>
      <svelte:fragment slot="h2">Meeting Scheduler</svelte:fragment>
    ...
    <BlogBodyWrapper>
      <ArticleWrapper>
        ...
        <ArticleAuthor>
          ...
          <a
            href="/"
            class="inline-flex items-center font-medium text-primary-600 dark:text-gray-400 hover:underline"
          >
            Read more
